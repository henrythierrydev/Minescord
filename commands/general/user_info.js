            ...
            if(i.customId === "follow") 
            {
                ...
                if(!localbase.users[currentUserID].following[followingUserID]) 
                {
                    ...
                    const successEmbed = new EmbedBuilder()
                        .setTitle(lang.userInfo.embed.success.follow.title)
                        .setColor(lang.userInfo.embed.success.follow.color)
                        .setDescription(lang.userInfo.embed.success.follow.description.replace('{user_name}', userName))
                        .setTimestamp();
