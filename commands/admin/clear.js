...
module.exports =
{
    ...
    async execute(interaction)
    {
        ...
        const successEmbed = new EmbedBuilder()
            .setTitle(lang.clear.embed.success.title)
            .setDescription(lang.clear.embed.success.description.replace('{value}', value).replace('{author}', author))
            .setColor(lang.clear.embed.success.color)
            .setTimestamp();
